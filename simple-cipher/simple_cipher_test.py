...
class SubstitutionCipherTest(unittest.TestCase):
    def test_encoding_with_noop_key(self):
        cipher = Cipher("a")
        plaintext = "hi"
        self.assertEqual(cipher.encode(plaintext), "hi")

    def test_encoding_with_single_shift(self):
        cipher = Cipher("b")
        plaintext = "hi"
        self.assertEqual(cipher.encode(plaintext), "ij")
