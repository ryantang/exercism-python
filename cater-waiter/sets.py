...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for diet_name, foods_in_diet in diets.items():
        if dish_ingredients <= foods_in_diet:
            return dish_name + ': ' + diet_name

    raise ValueError(f"'{dish_name} does not fit into a dietary category.")
...
def tag_special_ingredients(dish):
    ...
    special_ingredients_in_dish = set(ingredients) & SPECIAL_INGREDIENTS
    return (name, special_ingredients_in_dish)
